...
class Graph{
    ...
    void dfs(T src){
        ...
        // This will traverse all nodes of one connected component.
        dfsHelper(src, visited);

        // Lets now traverse all nodes of adjList to check if there exist anny unvisited nodes which are
        ...
        cout << "Total connected components are "<<counter << endl;
    }
};
